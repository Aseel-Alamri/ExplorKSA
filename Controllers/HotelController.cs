...
namespace FinalWebApplication.Controllers
{
    public class HotelController : Controller
    {
            ...
            List<Hotel> hotel = new List<Hotel>
        {
            ...
            {
                Id = 1,
                Name="Hilton Riyadh Olaya",
                City="Riyadh",
                Address="https://maps.app.goo.gl/7Up6CZnZmUbq5No47",
                Description="2.6 km away from Panorama Mall",
              ...
              new Hotel
            {
                ...
                Description="Located in Riyadh, 2.8 miles from Saqr Aljazeera Aviation Museum",
                ...
                new Hotel
            {
                ...
                Description="is located in the heart of the capital, next to the vibrant Tahlia Street and close to commercial and retail districts such as the financial district",
